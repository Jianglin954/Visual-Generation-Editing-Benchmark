...
- [*ICLR 2023*] **Training-Free Structured Diffusion Guidance for Compositional Text-to-Image Synthesis** [[PDF](https://arxiv.org/pdf/2212.05032)][[Code](https://github.com/weixi-feng/Structured-Diffusion-Guidance)]![GitHub Repo stars](https://img.shields.io/github/stars/weixi-feng/Structured-Diffusion-Guidance?style=social)

- [*ICCV 2023*] **DALL-Eval: Probing the Reasoning Skills and Social Biases of Text-to-Image Generation Models** [[PDF](https://arxiv.org/pdf/2202.04053)][[Code](https://github.com/j-min/DallEval)]![GitHub Repo stars](https://img.shields.io/github/stars/j-min/DallEval?style=social)

- [*NeurIPS 2022*] **Photorealistic Text-to-Image Diffusion Models with Deep Language Understanding** [[PDF](https://arxiv.org/pdf/2205.11487)][[Project](https://imagen.research.google/)]

- [*NeurIPS Workshop 2022 *] **Human Evaluation of Text-to-Image Models on a Multi-Task Benchmark** [[PDF](https://arxiv.org/pdf/2211.12112)]

- [*NeurIPS 2021*] **Benchmark for Compositional Text-to-Image Synthesis** [[PDF](https://openreview.net/pdf?id=bKBhQhPeKaF)][[Code](https://github.com/Seth-Park/comp-t2i-dataset)]![GitHub Repo stars](https://img.shields.io/github/stars/Seth-Park/comp-t2i-dataset?style=social)
